...
local function is_capitalized(str)
	...
	return capitalize_first_letter(str) == str
end

-- Adjust replacement word to match capitalization of original
...
-- Find the group and index of a word, case-insensitive
---@param word string?
...
-- Find the word under the cursor and its bounds, prioritizing keywords first
...
-- Flip the word under the cursor in the given direction
...
-- Flip to the next word in the group
function M.flip_next()
	flip(1)
end
-- Flip to the previous word in the group
