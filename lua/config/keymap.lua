...
util.mapL("e", "%", { desc = "Go to matching bracket" }, { "n", "v" })
...
util.nmap("H", "g^", { desc = "Move to the start of line" })
util.nmap("L", "g$", { desc = "Move to the end of line" })
util.nmap("U", function() cmd.redo() end, { desc = "Better redo" })
util.nmap("Q", "@q", { desc = "Use macro stored in the [q] register" })
...
util.vmap("Q", ":norm @q<CR>", { desc = "Use macro stored in the [q] register" })
